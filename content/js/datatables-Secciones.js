...
var table = $('#tabla').DataTable({      
  ...
  columnDefs: [
    {
        targets: [3], // El índice de la columna que deseas formatear
  ...
  buttons:[ 
{
  extend:    'excelHtml5',
  filename: function() {
    return "EXCEL-Secciones"      
  },          
  title: function() {
    var searchString = table.search();        
    return searchString.length? "Search: " + searchString : "Reporte de Secciones"
  },
...
},
{
  extend:    'print',
  filename: function() {
    return "Print-Secciones"      
  },          
  title: function() {
    var searchString = table.search();        
    return searchString.length? "Search: ": "Reporte de Secciones"
  },
