  ...
  buttons:[ 
{
  extend:    'excelHtml5',
  filename: function() {
    return "EXCEL-DOC-SIN-ENTRADA"      
  },          
  title: function() {
    var searchString = table.search();        
    return searchString.length? "Search: " + searchString : "Reporte de Doc. Sin Entrada"
  },
...
},
{
  extend:    'print',
  filename: function() {
    return "Print-DOC-SIN-ENTRADA"      
  },          
  title: function() {
    var searchString = table.search();        
    return searchString.length? "Search: ": "Reporte de Doc. Sin Entrada"
  },
