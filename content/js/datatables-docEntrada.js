  ...
  buttons:[ 
{
  extend:    'excelHtml5',
  filename: function() {
    return "EXCEL-DOC-ENTRADA"      
  },          
  title: function() {
    var searchString = table.search();        
    return searchString.length? "Search: " + searchString : "Reporte de Doc. de Entrada"
  },
...
},
{
  extend:    'print',
  filename: function() {
    return "Print-DOC-ENTRADA"      
  },          
  title: function() {
    var searchString = table.search();        
    return searchString.length? "Search: ": "Reporte de Doc. Entrada"
  },
